...
import '../../model/commerce/coupon.dart';
                          ...
                          children: [
                            Padding(
                              ...
                              child: GestureDetector(
                                onTap:(){
                                  Navigator.pushNamed(context, RouteTo.SHOP_ISSUE_COUPON, arguments: shop);
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text("issue coupon",style: TextStyle(color: Theme.of(context).primaryColor,fontSize: 10)
                                      ),
                                    ],
                                  ),
                                ),
                            ...
                            Container(
                              child: Column(
                                children: [
                                  GestureDetector(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Text("set Location",style: TextStyle(color: Theme.of(context).primaryColor,fontSize: 10)),
                                      ],
                                    ),
                                  ),
                                  SizedBox(
                                  ...
                                  GestureDetector(
                                    onTap: (){
                                      Navigator.pushNamed(context, RouteTo.SHOP_ADD_ITEM, arguments: shop);

                                    },
                                    child: Column(
                                      children: [
                                        Icon(Icons.add,color: Theme.of(context).primaryColor,),
                                        Text("Add Item",style: TextStyle(color: Theme.of(context).primaryColor,fontSize: 10)),
                                      ],
                                    ),
                                  ),
                                ],
                ...
                child: GestureDetector(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 5,),
                      Text("to upgrade to premium package",
                        textScaleFactor: 1.2,
                        style: TextStyle(
